let startWithVowelProbabilityPercentage = 0;
let useConsonantPrefixProbabilityPercentage = 100;
let useConsonantSuffixProbabilityPercentage = 100;
...
let consonants = {
   ...
   r: {
      ...
      beginning: [
         ...
         { grapheme: `gr`, weight: 25 }, // prevocalic cluster,
         ...
         { grapheme: `tr`, weight: 50 }, // prevocalic cluster,
         { grapheme: `br`, weight: 5 }, // prevocalic cluster,
         // { grapheme: `kr`, weight: 2 }, // prevocalic cluster,
         { grapheme: `chr`, weight: 1 }, // prevocalic cluster,
      ],
      end: [
...
function getRandomWordWithBrokenStuff(lengthModifier = 0) {
...
function getWordLength() {
   ...
   let trans = Math.pow(rand - 4.8, 3) * 0.01 + 0.75;
