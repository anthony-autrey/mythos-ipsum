let startWithVowelProbabilityPercentage = 5;
let useConsonantPrefixProbabilityPercentage = 20;
let useConsonantSuffixProbabilityPercentage = 40;
...
let consonants = {
   ...
   d: {
      ...
      middle: [
         ...
         { grapheme: `ed`, weight: 2 },
         { grapheme: `ds`, weight: 5 }, // postvocalic cluster
   ...
   k: {
      ...
      middle: [
         ...
         { grapheme: `k`, weight: 20 },
         { grapheme: `kk`, weight: 30 },
         ...
         // { grapheme: `c`, weight: 1 },
         { grapheme: `k`, weight: 20 },
         { grapheme: `kk`, weight: 40 },
         // { grapheme: `ch`, weight: 10 },
         { grapheme: `lk`, weight: 10 },
   ...
   l: {
      ...
      beginning: [
         ...
         { grapheme: `sl`, weight: 5 }, // prevocalic cluster
   ...
   r: {
      ...
      middle: [
         ...
         { grapheme: `dr`, weight: 1 }, // prevocalic cluster,
         { grapheme: `fr`, weight: 2 }, // prevocalic cluster,
         { grapheme: `br`, weight: 2 }, // prevocalic cluster,
         { grapheme: `gr`, weight: 2 }, // prevocalic cluster,
         { grapheme: `kr`, weight: 5 }, // prevocalic cluster,
         // { grapheme: `cr`, weight: 5 }, // prevocalic cluster,
   ...
   s: {
      ...
      middle: [
         ...
         { grapheme: `sk`, weight: 20 }, // postvocalic cluster
...
let vowels = {
   ...
   el: {
      weight: 0,
      beginning: [
         { grapheme: `ol`, weight: 1 },
         { grapheme: `al`, weight: 1 }
   ],
      middle: [
         { grapheme: `ol`, weight: 1 },
         { grapheme: `al`, weight: 1 }
